interface programCommitteeMembersProps {
  name: string;
  image: string;
  linkdin: string;
}
export const programCommitteeMembers: programCommitteeMembersProps[] = [
  ...
  {
    name: "محمّد مظفری",
    image: "/pics/MohammadMozafari.jpg",
    linkdin: "https://www.linkedin.com/in/mohammad-mozafary/",
  },
  {
    name: "احسان قاضی زاده",
    image: "/pics/ehsanGhazizade.jpg",
    linkdin: "https://www.linkedin.com/in/ehsan-ghazizadeh/",
  },
  {
    name: "سعید سوزنگر",
